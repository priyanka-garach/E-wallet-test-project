...
public class WithdrawMoneyPage extends SetupInit {
	WithdrawMoneyPageOperations withdrawMoneyPageOperations;
	DashBoardPageOperations dashboardPageCommon;
	CommonOperations common;
	elasticwrite log;

	public WithdrawMoneyPage(WebDriver driver, elasticwrite log) {
		this.log = log;
		this.driver = driver;
		withdrawMoneyPageOperations = new WithdrawMoneyPageOperations(this.driver, log);
		dashboardPageCommon = new DashBoardPageOperations(driver, log);
		common = new CommonOperations(this.driver, log);
	}

	public Map<Object, Object> withdrawMoney(Map<Object, Object> map) {
