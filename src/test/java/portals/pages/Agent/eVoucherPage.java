...
public class eVoucherPage extends SetupInit {
	portals.operations.Agent.eVoucherPageOperations eVoucherCustomerPageOperations;
	DashBoardPageOperations dashboardPageCommon;
	CommonOperations common;
	elasticwrite log;

	public eVoucherPage(WebDriver driver, elasticwrite log) {
		this.log = log;
		this.driver = driver;
		eVoucherCustomerPageOperations = new portals.operations.Agent.eVoucherPageOperations(driver, log);
		dashboardPageCommon = new DashBoardPageOperations(driver, log);
		common = new CommonOperations(this.driver, log);
	}

	public Map<Object, Object> eVoucher(Map<Object, Object> map) {
