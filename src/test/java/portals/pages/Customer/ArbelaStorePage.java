...
import portals.operations.Customer.ArbelaStorePageOperations;
import portals.operations.Customer.eVoucherPageOperations;
import utils.elasticUtils.elasticwrite;
import base.SetupInit;

public class ArbelaStorePage extends SetupInit {
	ArbelaStorePageOperations arbelaStorePageOperations;
	DashBoardPageOperations dashboardPageCommon;
	CommonOperations common;
	elasticwrite log;

	public ArbelaStorePage(WebDriver driver, elasticwrite log) {
		this.log = log;
		this.driver = driver;
		arbelaStorePageOperations = new ArbelaStorePageOperations(this.driver, log);
		dashboardPageCommon = new DashBoardPageOperations(driver, log);
		common = new CommonOperations(this.driver, log);
	}

	public Map<Object, Object> arbelaStore(Map<Object, Object> map) {
